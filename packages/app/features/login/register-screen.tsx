    ...
    >
        ...
        <View style={{ alignItems: 'center', width: '80%', maxWidth: 600, gap: 16, paddingTop: 12, paddingHorizontal: 20 }}>
              ...
              <View style={nameFieldStyle}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <StyledInput label="First Name" placeholder="Enter your first name" isPassword={false} additionalStyle={styles.shadowStyle} onChangeText={onChange} value={value} error={errors.firstName?.message}/>
                  )}
                />
              </View>
              <View style={nameFieldStyle}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <StyledInput label="Last Name" placeholder="Enter your last name" isPassword={false} additionalStyle={styles.shadowStyle} onChangeText={onChange} value={value} error={errors.lastName?.message}/>
                  )}
                />
              </View>
          </View>
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
                <StyledInput label="Email Address" placeholder="Enter your email" isPassword={false} additionalStyle={styles.shadowStyle} onChangeText={onChange} value={value} error={errors.email?.message}/>
            )}
          />
          <Controller
            control={control}
            ...
            render={({ field: { onChange, value } }) => (
                <StyledInput label="Password" placeholder="Enter your password" isPassword={true} additionalStyle={styles.shadowStyle} onChangeText={onChange} value={value} error={errors.password?.message}/>
            )}
          />
          <Controller
            control={control}
            ...
            render={({ field: { onChange, value } }) => (
                <StyledInput label="Confirm Password" placeholder="Confirm your password" isPassword={true} additionalStyle={styles.shadowStyle} onChangeText={onChange} value={value} error={errors.confirmPassword?.message}/>
            )}
          />
          <Controller
            control={control}
              ...
              <FormCheckbox 
                ...
                label={
                  <Text style={{ color: '#FFF' }}>
                    I agree to the <Text style={{ color: '#c2b75f', textDecorationLine: 'underline' }}>MLH Code of Conduct</Text>
                  </Text>
                } 
