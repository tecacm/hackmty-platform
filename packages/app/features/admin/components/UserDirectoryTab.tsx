              ...
              return (
                ...
                >
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 14 }}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 6, alignItems: 'center' }}>
                      {user.applications.length === 0 ? (
                        <Text style={{ fontSize: 11, color: '#94a3b8', fontStyle: 'italic' }}>No Applications</Text>
                      ) : (
                    ...
                    <View style={{ flexDirection: 'row', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                      <PillButton
                        ...
                        additionalStyle={{ height: 36, paddingHorizontal: 14, width: 'auto', backgroundColor: '#6d28d9' }}
                        fontSize={12}
                      />
                      <PillButton
                        title={isResetSent ? '✓ Email Sent!' : 'Password Reset'}
                        onPress={() => handleSendPasswordReset(user.email, user.id)}
                        variant={isResetSent ? 'primary' : 'outline-primary'}
                        additionalStyle={{ height: 36, paddingHorizontal: 14, width: 'auto' }}
                        fontSize={12}
                      />
                    </View>
                  </View>
                  ...
                  {(user.university || user.major || user.phone) && (
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 16, borderTopWidth: 1, borderColor: '#f1f5f9', paddingTop: 10, marginTop: 4 }}>
